...
insert into Category (codigo, nombre) values ('MLA1743','Autos, Motos y Otros');
insert into Category (codigo, nombre) values ('MLA1384','Bebés');
insert into Category (codigo, nombre) values ('MLA1246','Belleza y Cucodigoado Personal');
